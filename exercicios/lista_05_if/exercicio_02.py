...
entrada = input('Entre com o seu e-mail funcional: ')

email_padrao = entrada.lower().strip()

if email_padrao in admins:
    print(f'Acesso liberado! Bem-vindo ao painel de controle')
else:
    print(f'Acesso negado. Você não tem permissões de administrador')
